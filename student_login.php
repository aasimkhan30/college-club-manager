<?php
session_start();
if(isset($_SESSION["student_id"]))//user already logged in 
...
-->
 ...
 <!DOCTYPE html>
  <html>
    ...
    <div class="col s12">
      <ul class="tabs">
        <li class="tab col s3"><a class="active" href="#test1">Students</a></li>
    ...
    <?php
      ...
      ?>
      <div class="center-align"><p><span style="font-size:20px;">LOGIN IN TO YOUR ACCOUNT</span></p></div>
      <div class="row">
        <form action="student_login_connect.php" method="POST">
        ...
        <div class="col s12">
          <button  type="submit"  class="waves-effect waves-light btn green" style="width:100%;">LOGIN</button></div>
